...
<body onload="focus()">
	<h1>統一發票對獎-201709~10</h1>
	<p>開獎日期：106年11月25日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;領獎期限：106年12月06日至107年03月05日</p>
	<table border="1" cellspacing="1" cellpadding="0">
		...
		<tr>
			...
			<td><span class="Red">26638985</span><br>同期統一發票收執聯 8 位數號碼與上列號碼相同者獎金 1,000 萬元</td>
		</tr>
		<tr>
			<td style="text-align:center">特獎</td>
			<td><span class="Red">37266877</span><br>同期統一發票收執聯 8 位數號碼與上列號碼相同者獎金 200 萬元</td>
		</tr>
		<tr>
			<td style="text-align:center">頭獎</td>
			<td><span class="Red">15720791、21230260、55899892</span><br>同期統一發票收執聯 8 位數號碼與上列號碼相同者獎金 20 萬元</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><span class="Red">248、285、453</span><br>同期統一發票收執聯末 3 位數號碼與上列號碼相同者各得獎金 2 百元</td>
		</tr>
	</table>
	<br>
...
<?php
	...
	if (isset($number) && ($number != "")) {
		...
		elseif ($number6 == $sixth1 || $number6 == $sixth2 || $number6 == $sixth3 || $number6 == $sixth4 || $number6 == $sixth5 || $number6 == $sixth6) {
			echo"<p>恭喜你，中六獎</p>";
			echo "<img src=\"Win.jpg\">";
		}
		else {
